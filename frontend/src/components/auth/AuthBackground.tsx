...
const AuthBackground = ({ children }: any) => {
  return (
    <div className=" h-screen w-screen overflow-x-hidden dark:bg-transparent bg-white  dark:bg-grid-white/[0.2] bg-grid-black/[0.2] relative flex items-center justify-center">
